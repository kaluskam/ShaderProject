...
class MyApp : public mgl::App {
 ...
 private:
  ...
  void createScene();
  void drawScene();
  void rotateActive(const glm::vec3 axis);
};
...
void MyApp::createCamera() {
  ...
  vmInfo1.Eye = glm::vec3(5.0f, 5.0f, 5.0f);
  vmInfo1.Up = glm::vec3(0.0f, 1.0f, 0.0f);
  vmInfo1.viewMatrix = ViewMatrix1;

  mgl::Camera::ViewMatrixInfo vmInfo2{};
  vmInfo2.Eye = glm::vec3(-5.0f, -5.0f, -5.0f);
  vmInfo2.Up = glm::vec3(0.0f, .0f, 1.0f);
...
void MyApp::rotateActive(const glm::vec3 axis) {
    Camera->rotate(axis);
}
